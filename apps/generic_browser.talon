...
pattern summary: "Inquisitive pragmatic engineer with 10 years of frontend experience
In building UI interfaces using HTML5, CSS3, SCSS, CSS in JS and Javascript/Typescript/Node.js, with 5 yrs of ReactJS and 2 yrs of NextJs experience.
Experimenting on leveraging AI tools like github copilot, claude, etc.. to improve code quality, frontend performance, follow design system, follow 95% code coverage with zero vulnerabilities." 
